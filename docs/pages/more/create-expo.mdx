...
const App = () => {
  ...
  const handleSubmit = () => {
    if (name && phone && date) {
      Alert.alert('Programare realizată!', 
Nume: ${name}\nTelefon: ${phone}\nData: ${date}
);
      // Aici poți adăuga logica pentru a salva programarea
    } else {
  ...
  return (
      ...
      Programare Reparație Tapițerie
              style={styles.input}
      ...
      />
              style={styles.input}
        placeholder="Data programării (ex: 10/12/2024)"
        value={date}
